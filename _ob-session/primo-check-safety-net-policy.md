...
ai:
  - name: "Claude"
    persona: "FlowSense"
    model: "Sonnet 4.5"
    role: "Creazione policy + coordinamento"
    slug: "claude-flowsense"
  - name: "Claude"
    persona: "SafetyNet-Claude"
    model: "Sonnet 4.5"
    role: "Validazione policy (guardrail Claude)"
    slug: "claude-safetynet"
  - name: "ChatGPT"
    persona: "SafetyNet-GPT"
    model: "GPT 5.1"
    role: "Validazione policy (guardrail GPT)"
    slug: "chatgpt-safetynet"
  - name: "Gemini"
    persona: "SafetyNet-Gemini"
    model: "Gemini 2.5 Flash"
    role: "Validazione policy (guardrail Gemini)"
    slug: "gemini-safetynet"
  - name: "Grok"
    persona: "SafetyNet-Grok"
    model: "Grok 4"
    role: "Validazione policy (guardrail Grok)"
    slug: "grok-safetynet"
  - name: "GLM-4.6v"
    persona: "SafetyNet-GLM"
    model: "GLM-4.6v"
    role: "Validazione policy (guardrail GLM)"
    slug: "glm-safetynet"
puck:
  name: "Puck"
  role: "Ponte umano e routing validazioni"
...
related_sessions:
  - slug: "allineare-due-ai-layout"
    ...
    ai_slug: "claude-vela"
    note: "Prima sessione multi-AI documentata"

related_artefatti:
  - title: "Safety First v1.2 — Documento Fondativo"
    url: "/safety-first/"
...
archivio_filters:
  - label: "AI = Claude (FlowSense)"
    url: "/archivio/?ai=claude-flowsense"
...
<!-- 🌊 FlowSense: Ob Session #002 - 09/12/2025 -->
<!-- Primo check Safety Net multi-AI su policy blog -->
<!-- fIGA 95/100 - Documento più sensibile e più validato -->
<!-- Modifiche Gemini integrate in Insight 4 e 5 -->
